...
export default function FeaturedStory() {
  return (
    <section
      id="stories"
      className="relative overflow-hidden bg-[var(--ink)] py-24 sm:py-28 lg:py-32"
    >
      {/* Decorative glow */}
      <div className="absolute -left-32 top-20 h-[360px] w-[360px] rounded-full bg-[var(--green-soft)]/10 blur-3xl" />
      <div className="absolute -right-40 bottom-0 h-[420px] w-[420px] rounded-full bg-[var(--green)]/60 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-[1440px] px-6 lg:px-12">
        ...
        <div className="mb-14 grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
          ...
          >
            <h2 className="max-w-3xl text-4xl font-bold leading-[1.05] tracking-[-0.04em] text-white sm:text-5xl lg:text-6xl">
              ...
              <span className="block text-[var(--green)]">a human story.</span>
            </h2>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="relative min-h-[420px] lg:min-h-[620px]">
            ...
            {/* Floating category */}
            <div className="absolute left-6 top-6 rounded-full bg-[var(--green-soft)] px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-[var(--ink)] sm:left-8 sm:top-8">
              Education
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between p-8 sm:p-10 lg:p-14">
            <div>
              {/* Quote icon */}
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#eaf6ef] text-[var(--ink)]">
                <Quote size={21} />
              </div>

              {/* Quote */}
              <blockquote className="mt-8 max-w-xl text-2xl font-semibold leading-[1.35] tracking-[-0.02em] text-[var(--ink)] sm:text-3xl lg:text-4xl">
            ...
            <div className="mt-10 border-t border-neutral-200 pt-7">
              <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a
                  href="/stories"
                  className="group inline-flex items-center gap-3 text-sm font-bold text-[var(--green)]"
                >
                  Read the full story
                  <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--green)] text-white transition-transform duration-300 group-hover:rotate-45">
          ...
          {[
            ...
            >
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold tracking-[0.18em] text-[var(--green)]">
                  {story.number}
                </span>

                <ArrowUpRight
                  size={17}
                  className="text-white/40 transition duration-300 group-hover:rotate-45 group-hover:text-[var(--green)]"
                />
              </div>
